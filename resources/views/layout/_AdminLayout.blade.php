...
<body @yield('app')  @yield('controller') >
    ...
    <script src="{{asset('/js/encuestas/turismoReceptor/services/grupoViajeServices.js')}}" type="text/javascript"></script>
    <script src="{{asset('/js/encuestas/turismoReceptor/grupo_viaje.js')}}" type="text/javascript"></script> 
