                    ...
                    <ul role="menubar">
                        <li>
                           ...
                           <ul role="menu" id="menuPromocion" aria-label="Promoción">
        					    ...
        					    <li role="none"><a role="menuitem" href="{{asset('/InformacionDepartamento/configuracionacercade')}}">Acerca de</a></li>
        					    <li role="none"><a role="menuitem" href="{{asset('/InformacionDepartamento/configuracionrequisitos')}}">Requisitos de viaje</a></li>
        					    <li role="none"><a role="menuitem" href="{{asset('o/publicaciones/listadoadmin')}}">Biblioteca Digital</a></li>
