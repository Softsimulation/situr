...
@section('title', 'Periodos Sostenibilidad PST')

@section('TitleSection', 'Lista de registros')

@section('app','ng-app="periodosSostenibilidadPstApp"')

@section('controller','ng-controller="periodosSostenibilidadPstController"')
...
@section('titulo','Periodos sostenibilidad pst')
                    ...
                    <table class="table table-striped">
                        ...
                        <tr dir-paginate="item in registros |itemsPerPage:10 as results" pagination-id="paginacion_registros" >
                            ...
                            <td style="text-align: center;">
                                <a class="btn" title="Ver detalle" href="/periodoSostenibilidadPst/detalle/@{{item.id}}"><span class="glyphicon glyphicon-th-list"></span></a>
