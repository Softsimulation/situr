...
@section('meta_og')
<meta property="og:title" content="Conoce {{$atraccion->sitio->sitiosConIdiomas[0]->nombre}} en el departamento del Atlántico" />
      ...
      <div class="carousel-caption">
          <h2>{{$atraccion->sitio->sitiosConIdiomas[0]->nombre}}
              <small class="btn-block">
	              <span class="{{ ($atraccion->calificacion_legusto > 0.0) ? (($atraccion->calificacion_legusto <= 0.9) ? 'ionicons-inline ion-android-star-half' : 'ionicons-inline ion-android-star') : 'ionicons-inline ion-android-star-outline'}}" aria-hidden="true"></span>
	              <span class="{{ ($atraccion->calificacion_legusto > 1.0) ? (($atraccion->calificacion_legusto <= 1.9) ? 'ionicons-inline ion-android-star-half' : 'ionicons-inline ion-android-star') : 'ionicons-inline ion-android-star-outline'}}" aria-hidden="true"></span>
	              <span class="{{ ($atraccion->calificacion_legusto > 2.0) ? (($atraccion->calificacion_legusto <= 2.9) ? 'ionicons-inline ion-android-star-half' : 'ionicons-inline ion-android-star') : 'ionicons-inline ion-android-star-outline'}}" aria-hidden="true"></span>
	              <span class="{{ ($atraccion->calificacion_legusto > 3.0) ? (($atraccion->calificacion_legusto <= 3.9) ? 'ionicons-inline ion-android-star-half' : 'ionicons-inline ion-android-star') : 'ionicons-inline ion-android-star-outline'}}" aria-hidden="true"></span>
	              <span class="{{ ($atraccion->calificacion_legusto > 4.0) ? (($atraccion->calificacion_legusto <= 5.0) ? 'ionicons-inline ion-android-star-half' : 'ionicons-inline ion-android-star') : 'ionicons-inline ion-android-star-outline'}}" aria-hidden="true"></span>
    ...
    <section id="comentarios">
        <div class="container">
            ...
            <div class="text-center">
                ...
                <a id="btn-share-twitter" href="https://twitter.com/home?status=Realiza {{$atraccion->atraccionesConIdiomas[0]->nombre}} en el departamento del Atlántico. Conoce más en {{\Request::url()}}" class="btn btn-info" target="_blank" rel="noopener noreferrer"><span class="ion-social-twitter" aria-hidden="true"></span> Twitter</a>
