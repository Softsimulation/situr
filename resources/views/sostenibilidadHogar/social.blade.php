    ...
    <form name="socialForm" role="form" novalidate>
        ...
        <div class="panel panel-success">
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title"><b>P1. ¿Le agrada la llegada de turistas a Atlántico?</b></h3>
                </div>
        ...
        <div class="panel panel-success">
            <div class="panel-heading p3">
                <h3 class="panel-title"><b><span class="asterik glyphicon glyphicon-asterisk"></span> P.2 En una escala de 1 a 10, donde 1 es Muy Malo y 10 Excelente. ¿Cómo califica el trato entre los habitantes de Atlántico y los turistas? </b></h3>
            </div>
        ...
        <div class="panel panel-success">
                <div class="panel-heading">
                    <!-- P2. ¿El viaje al departamento hizo parte de un paquete/plan turístico o excursión?-->
                    <h3 class="panel-title"><b><span class="asterik glyphicon glyphicon-asterisk"></span>P3. Califique como alto, medio y bajo su nivel de conocimiento de los servicios, productos y atractivos culturales que ofrece Atlántico</b></h3>
                </div>
                <div class="panel-footer"><b>Respuesta única</b></div>
                <div class="panel-body">
                    <div class="row">
        ...
        <div class="panel panel-success" ng-show="social.criterios_calificacion_id!=4 && social.criterios_calificacion_id != undefined">
                <div class="panel-heading">
                    <!-- P2. ¿El viaje al departamento hizo parte de un paquete/plan turístico o excursión?-->
                    <h3 class="panel-title"><b><span class="asterik glyphicon glyphicon-asterisk"></span>P.3.1. ¿Ofrece información a los visitantes sobre los servicios, productos, atractivos turísticos y culturales que hay en Atlántico?</b></h3>
                </div>
                <div class="panel-footer"><b>Respuesta única</b></div>
                <div class="panel-body">
                    <div class="row">
        ...
        <div class="panel panel-success">
                <div class="panel-heading">
                    <!-- P2. ¿El viaje al departamento hizo parte de un paquete/plan turístico o excursión?-->
                    <h3 class="panel-title"><b><span class="asterik glyphicon glyphicon-asterisk"></span>P.4 ¿Ha sido parte de alguna asociación o gremio que ofrezca servicios turísticos en Atlántico?</b></h3>
                </div>
                <div class="panel-footer"><b>Respuesta única</b></div>
                <div class="panel-body">
                    <div class="row">
        ...
        <div class="panel panel-success">
                <div class="panel-heading">
                    <!-- P2. ¿El viaje al departamento hizo parte de un paquete/plan turístico o excursión?-->
                    <h3 class="panel-title"><b><span class="asterik glyphicon glyphicon-asterisk"></span>P.5 ¿Ha participado en  alguna  de  las  siguientes  acciones  para  conservar  y  rescatar  la  cultura  del Atlántico?</b></h3>
                </div>
         ...
         <div class="panel panel-success">
            <div class="panel-heading p3">
                <h3 class="panel-title"><b><span class="asterik glyphicon glyphicon-asterisk"></span> P.7 En una escala de 1 a 10, donde 1 es Muy Insatisfecho y 10 Muy Satisfecho, ¿Cómo calificaría su nivel de satisfacción con la llegada de turistas a Atlántico?</b></h3>
            </div>
            <div class="panel-footer"><b>Pregunta con selección única</b></div>
            <div class="panel-body">
                <div class="row">
        ...
        <div class="panel panel-success">
                <div class="panel-heading">
                    <!-- P2. ¿El viaje al departamento hizo parte de un paquete/plan turístico o excursión?-->
                    <h3 class="panel-title"><b>P8. ¿Cree que la llegada de turistas ha incidido en la calidad de vida de Atlántico?</b></h3>
                </div>
                <div class="panel-footer"><b>Respuesta  única </b></div>
                <div class="panel-body">
                    <div class="row">
        ...
        <div class="panel panel-success" ng-show="social.cambian_turistas==  true">
                <div class="panel-heading">
                    <h3 class="panel-title"><b><span class="asterik glyphicon glyphicon-asterisk"></span>P.8.1 De los siguientes factores de calidad de vida, ¿Cuáles cree que han mejorado, desmejorado o permanecen igual en Atlántico, como consecuencia del turismo?</b></h3>
                </div>
                <div class="panel-footer"><b>Respuesta múltiple</b></div>
                <div class="panel-body">
                    <div class="row">
        ...
        <div class="panel panel-success">
         ...
         <div class="panel panel-success">
                <div class="panel-heading">
                    <!-- P2. ¿El viaje al departamento hizo parte de un paquete/plan turístico o excursión?-->
                    <h3 class="panel-title"><b><span class="asterik glyphicon glyphicon-asterisk"></span>P.10 ¿Posee viviendas, distintas a la vivienda donde reside, que estén siendo destinadas para turismo en  Atlántico?</b></h3>
                </div>
                <div class="panel-footer"><b>Respuesta única</b></div>
                <div class="panel-body">
                    <div class="row">
        ...
        <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title"><b>P.11 De los siguientes factores de identidad cultural, ¿En cuáles percibe que el turismo ha tenido un efecto positivo o negativo en Atlántico</b></h3>
                </div>
                <div class="panel-footer"><b>Respuesta múltiple</b></div>
                <div class="panel-body">
                    <div class="row">
         ...
         <div class="panel panel-success">
                <div class="panel-heading">
                    <!-- P2. ¿El viaje al departamento hizo parte de un paquete/plan turístico o excursión?-->
                    <h3 class="panel-title"><b><span class="asterik glyphicon glyphicon-asterisk"></span>P.11.1 Califique como positivo o negativo el efecto que ha tenido el turismo en las costumbres y tradiciones en Atlántico</b></h3>
                </div>
                <div class="panel-footer"><b>Respuesta única</b></div>
                <div class="panel-body">
                    <div class="row">
        ...
        <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title"><b><span class="asterik glyphicon glyphicon-asterisk"></span>P.12 De los siguientes beneficios socioculturales que se generan por el turismo, ¿Cuáles cree que han mejorado, desmejorado o permanecen igual en Atlántico</b></h3>
                </div>
                <div class="panel-footer"><b>Respuesta múltiple</b></div>
                <div class="panel-body">
                    <div class="row">
         ...
         <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title"><b>P.13 Mencione los efectos positivos y negativos generados por el turismo en la conservación de las costumbres, tradiciones y patrimonio cultural del Atlántico</b></h3>
                </div>
                <div class="panel-footer"><b>Respuesta múltiple</b></div>
                <div class="panel-body">
                    <div class="row">
