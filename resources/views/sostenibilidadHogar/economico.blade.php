    ...
    <form role="form" name="datosForm" novalidate>
        ...
        <div class="panel panel-success">
            <div class="panel-heading p3">
                <h3 class="panel-title"><b><span class="asterik glyphicon glyphicon-asterisk"></span> P.21 ¿Cree que el turismo contribuirá, a largo plazo, a mejorar la situación económica de los habitantes del Departamento del Atlántico?</b></h3>
            </div>
        ...
        <div class="panel panel-success" ng-show="encuesta.contribuira == 1">
            <div class="panel-heading">
                <h3 class="panel-title"><b><span class="asterik glyphicon glyphicon-asterisk"></span> P.21.1 Teniendo en  cuenta lo  anterior, ¿Qué  aspectos  cree  que mejorarían  la  situación  económica del Departamento del Atlántico?</b></h3>
            </div>
        ...
        <div class="panel panel-success">
            <div class="panel-heading p3">
                <h3 class="panel-title"><b><span class="asterik glyphicon glyphicon-asterisk"></span> P.23 De los siguientes beneficios económicos que se generan por el turismo, ¿Cuáles cree que han mejorado o desmejorado en el Departamento del Atlántico?</b></h3>
            </div>
        ...
        <div class="panel panel-success">
            <div class="panel-heading p3">
                <h3 class="panel-title"><b><span class="asterik glyphicon glyphicon-asterisk"></span> P.24 Califique como positivos o negativos los impactos económicos del turismo en el el Departamento del Atlántico?</b></h3>
            </div>
            <div class="panel-footer"><b>Pregunta con selección única</b></div>
            <div class="panel-body">
                <div class="row">
        ...
        <div class="panel panel-success">
            <div class="panel-heading p3">
                <h3 class="panel-title"><b><span class="asterik glyphicon glyphicon-asterisk"></span> P.25 De los siguientes riesgos económicos en función del turismo sostenible ¿Cuáles considera que representan un riesgo alto, medio o bajo en el Departamento del Atlántico? </b></h3>
            </div>
            <div class="panel-footer"><b>Pregunta con selección única para la calificación</b></div>
            <div class="panel-body">
                <div class="row">
        ...
        <div class="panel panel-success">
            <div class="panel-heading p3">
                <h3 class="panel-title"><b><span class="asterik glyphicon glyphicon-asterisk"></span> P.27 Dando cumplimiento a la ley de Protección de datos personales, solicito su autorización para que SITUR Atlántico pueda contactarlo nuevamente. ¿Está usted de acuerdo? </b></h3>
            </div>
            <div class="panel-footer"><b>Pregunta con selección única</b></div>
            <div class="panel-body">
                <div class="row">
        ...
        <div class="panel panel-success">
            <div class="panel-heading p3">
                <h3 class="panel-title"><b><span class="asterik glyphicon glyphicon-asterisk"></span> P.28 Ya para terminar, le solicito su autorización para que SITUR Atlántico comparta sus respuestas con las entidades que contrataron el proyecto, ¿Está usted de acuerdo? </b></h3>
            </div>
            <div class="panel-footer"><b>Pregunta con selección única</b></div>
            <div class="panel-body">
                <div class="row">
