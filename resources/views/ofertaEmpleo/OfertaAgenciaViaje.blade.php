...
@section('title', 'Oferta de agencia de viaje :: SITUR Atlántico')
...
<div class="container">
    ...
    <form role="form" name="DatosForm" novalidate>
                    ...
                    <div class="col-md-12">
                        <table class="table table-bordered table-striped">
                            <tr>
                                ...
                                <th class="text-center">¿Qué porcentaje fue comprado por residentes en el Atlántico? (%)</th>
                                <th class="text-center">¿Qué porcentaje fue comprado por residentes en Colombia fuera del Atlántico? (%)</th>
                            </tr> 
                    ...
                    <div ng-repeat="i in destinos">
                        ...
                        <div class="col-md-12">
                            <span ng-show="DatosForm.$submitted || DatosForm.nacional@{{$index}}.$touched">
                                <span class="label label-danger" ng-show="DatosForm.nacional@{{$index}}.$error.required">*El porcentaje comprado por los residentes en el Atlántico en la fila @{{$index+1}} es obligatorio</span>
                                <span class="label label-danger" ng-show="DatosForm.nacional@{{$index}}.$error.number">*El porcentaje comprado por los residentes en el Atlántico en la fila @{{$index+1}} debe ser un número</span>
                                <span class="label label-danger" ng-show="DatosForm.nacional@{{$index}}.$error.max">*El porcentaje comprado por los residentes en el Atlántico en la fila @{{$index+1}} debe ser menor o igual que 100</span>
                                <span class="label label-danger" ng-show="DatosForm.nacional@{{$index}}.$error.min">*El porcentaje comprado por los residentes en el Atlántico en la fila @{{$index+1}} debe ser mayor que 0</span>
                            </span>
                        </div>
                        <div class="col-md-12">
                            <span ng-show="DatosForm.$submitted || DatosForm.internacional@{{$index}}.$touched">
                                <span class="label label-danger" ng-show="DatosForm.internacional@{{$index}}.$error.required">*El porcentaje comprado por los residentes fuera del Atlántico en la fila @{{$index+1}} es obligatorio</span>
                                <span class="label label-danger" ng-show="DatosForm.internacional@{{$index}}.$error.number">*El porcentaje comprado por los residentes fuera del Atlántico en la fila @{{$index+1}} debe ser un número</span>
                                <span class="label label-danger" ng-show="DatosForm.internacional@{{$index}}.$error.max">*El porcentaje comprado por los residentes fuera del Atlántico en la fila @{{$index+1}} debe ser menor o igual que 100</span>
                                <span class="label label-danger" ng-show="DatosForm.internacional@{{$index}}.$error.min">*El porcentaje comprado por los residentes fuera del Atlántico en la fila @{{$index+1}} debe ser mayor que 0</span>
                            </span>
                        </div>
                   </div>
                </div>
        ...
        <div class="panel panel-success" ng-show="encuesta.ofrecePlanesConDestino == true">
            <div class="panel-heading">
                <h3 class="panel-title"><b><span class="asterik glyphicon glyphicon-asterisk"></span>Personas que viajaron con planes, cuyo destino fue Atlántico</b></h3>
            </div>
            <div class="panel-footer"><b>Complete la información de la tabla</b></div>
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-12">
                        <table class="table table-bordered table-striped">
                            ...
                            <tr>
                                <td class="text-center">¿Cuántas personas viajaron con planes con destino Atlántico?</td>
                                <td>
                    ...
                    <div>
                        ...
                        <div class="col-md-12">
                            <span ng-show="DatosForm.$submitted || DatosForm.magdalena.$touched">
                                <span class="label label-danger" ng-show="DatosForm.magdalena.$error.required">*El porcentaje comprado por residentes en el Atlántico es obligatorio</span>
                                <span class="label label-danger" ng-show="DatosForm.magdalena.$error.number">*El porcentaje comprado por residentes en el Atlántico debe ser un número</span> 
                                <span class="label label-danger" ng-show="DatosForm.magdalena.$error.max">*El porcentaje comprado por residentes en el Atlántico debe ser menor o igual que 100</span>
                                <span class="label label-danger" ng-show="DatosForm.magdalena.$error.min">*El porcentaje comprado por residentes en el Atlántico debe ser mayor que 1</span>
                            </span>
                        </div>
                        <div class="col-md-12">
                            <span ng-show="DatosForm.$submitted || DatosForm.nacional.$touched">
                                <span class="label label-danger" ng-show="DatosForm.nacional.$error.required">*El porcentaje comprado por residentes fuera del Atlántico es obligatorio</span>
                                <span class="label label-danger" ng-show="DatosForm.nacional.$error.number">*El porcentaje comprado por residentes fuera del Atlántico debe ser un número</span>
                                <span class="label label-danger" ng-show="DatosForm.nacional.$error.max">*El porcentaje comprado por residentes fuera del Atlántico debe ser menor o igual que 100</span>
                                <span class="label label-danger" ng-show="DatosForm.nacional.$error.min">*El porcentaje comprado por residentes fuera del Atlántico debe ser mayor que 1</span>
                            </span>
                        </div>
                        <div class="col-md-12">
