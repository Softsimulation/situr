...
@endif
    ...
    <section id="informacionGeneral" class="section active">
        <div class="container">
            <h3 class="title-section">{{$destino->destinoConIdiomas[0]->nombre}} {{-- <small class="btn-block">{{$destino->tipoDestino->tipoDestinoConIdiomas[0]->nombre}}</small> --}}</h3>
            <div class="row">
                <div class="col-xs-12">
    ...
    <section id="comentarios">
        <div class="container">
            ...
            <div class="text-center">
                ...
                <a id="btn-share-twitter" href="https://twitter.com/home?status=Realiza {{$destino->destinoConIdiomas[0]->nombre}} en el departamento del Atlántico. Conoce más en {{\Request::url()}}" class="btn btn-info" target="_blank" rel="noopener noreferrer"><span class="ion-social-twitter" aria-hidden="true"></span> Twitter</a>
