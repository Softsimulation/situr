...
@section('content')
    ...
    <!--        <h2 style="font-weight: 600;">¡@Resource.LabelBienvenidos!</h2>-->
    <!--        <p style="font-size: 1.2em;font-weight: 400;">@Resource.EncuestaReceptorMsgIntroduccion3</p>-->
    <!--        <p style="font-size: 1.2em; font-weight: 400;">@Resource.EncuestaReceptorMsgIntroduccion4</p>-->
    <!--        <p style="font-size: 1.2em; font-weight: 400;">@Resource.EncuestaReceptorMsgIntroduccion1</p>-->
    <!--        <p style="font-size: 1.2em;font-weight: 400;">@Resource.EncuestaReceptorMsgIntroduccion2</p>-->
    <!--    </div>-->
    <!--</div>-->
    ...
    <form role="form" name="DatosForm" novalidate>
        ...
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-12">
                        <select class="form-control" name="encuestador" ng-options="item.id as item.user.username for item in encuestadores" ng-model="encuesta.Encuestador" ng-required="true">
                    ...
                    <div class="col-xs-12 col-sm-4 col-md-4">
                        <div class="form-group">
                            ...
                            <div class="col-xs-12">
                                ...
                                <select class="form-control" id="aplicacion" name="aplicacion" ng-options="item.id as item.nombre for item in lugares_aplicacion" ng-model="encuesta.aplicacion" ng-required="true">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="radio radio-primary" style="display: inline-block;">
                                    <label>
                                        <!--P4P4Radio1. Hombre-->
                                        <input type="radio" name="sexo" ng-model="encuesta.Sexo" value="1" ng-required="true">
                                        Hombre
                                    </label>
                                </div>
                                <div class="radio radio-primary" style="display: inline-block;">
                                    <label>
                                        <!--P4P4Radio2. Mujer-->
                                        <input type="radio" name="sexo" ng-model="encuesta.Sexo" value="0" ng-required="true">
                                        Mujer
                                    </label>
                                </div>
                ...
                <div class="row">
                    ...
                    <div ng-class="{true:'col-xs-12 col-sm-12 col-md-3',false:'col-xs-12 col-sm-12 col-md-6'}[encuesta.Nacimiento == 3]">
                        <div class="form-group">
                            ...
                            <div class="col-xs-12">
                                <!--P4P7Select1. Seleccione el lugar de nacimiento-->
                                <select class="form-control" id="inputDondeNacio" ng-options="item.id as item.opciones_lugares_con_idiomas[0].nombre for item in lugares" name="nacimiento" ng-model="encuesta.Nacimiento" ng-required="true">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-4">
                        <div class="form-group">
                            ...
                            <label for="inputPaisResidencia" class="col-xs-12 control-label">A1. País de Residencia</label>

                            <div class="col-xs-12">
                                <!--P4P9Select1. País de Residencia-->
                                <select class="form-control" ng-model="pais_residencia" ng-options="item.id as item.paises_con_idiomas[0].nombre for item in paises| orderBy:'paises_con_idiomas[0].nombre'" id="inputPaisResidencia" name="pais_residencia" ng-change="changedepartamento()" ng-required="true">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4">
                        <div class="form-group">
                            ...
                            <label for="inputDepartamentoResidencia" class="col-xs-12 control-label">A1. 1 Departamento de Residencia</label>

                            <div class="col-xs-12">
                                <!--P4P10Select1. Seleccione un Departamento-->
                                <select class="form-control" id="inputDepartamentoResidencia" ng-options="item.id as item.nombre for item in departamentos" name="departamento" ng-model="departamento" ng-change="changemunicipio()" ng-required="true">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4">
                        <div class="form-group">
                            ...
                            <label for="inputCiudadResidencia" class="col-xs-12 control-label">A2. Ciudad de Residencia</label>
                            <!--P4P11. Seleccione un Municipio-->
                            <div class="col-xs-12">
                                <select class="form-control" id="inputCiudadResidencia" ng-options="item.id as item.nombre for item in municipios| orderBy:'nombre'" name="ciudad" ng-model="encuesta.Municipio" ng-required="true">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-xs-12">
                                ...
                                <select class="form-control" name="destino" ng-model="encuesta.Destino" ng-options="item.id as item.nombre for item in municipios_colombia | orderBy:'nombre'" ng-required="pais_residencia != 47">
                                    <option value="" disabled>Seleccione un Municipio</option>
                                </select>
