    ...
    <form role="form" name="datosForm" novalidate>
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <h3 class="panel-title"><b><span class="asterik glyphicon glyphicon-asterisk"></span> P.24 ¿Qué porcentaje de proveedores  de su  empresa son del Atlántico ? Es decir, % de empresas locales que producen su bien o servicio en @{{proveedor.razon_social}}.</b></h3>
            </div>
