...
@section('title', 'Bolsa de empleo :: Formulario para el registro de vacantes')

@section('TitleSection', 'Formulario para el registro de vacantes')
...
@section('subtitulo','Formulario para el registro de vacantes')
...
@section('content')
       ...
       <div>
            <form name="datosForm" role="form" novalidate>
                <fieldset>
                    <legend>Formulario de ingreso de vacantes</legend>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-md-8">
                            <div class="form-group" ng-class="{'has-error' : (datosForm.$submitted || datosForm.nombre_vacante.$touched) && datosForm.nombre_vacante.$error.required}">
                                ...
                                <input type="text" class="form-control" id="nombre_vacante" name="nombre_vacante" ng-model="vacante.nombre_vacante" maxlength="250" placeholder="Ingrese el nombre de la vacanta. Máx. 255 caracteres" required />
                        ...
                        <div class="col-xs-12 col-md-4">
                            <div class="form-group" ng-class="{'has-error' : (datosForm.$submitted || datosForm.nivelEducacion.$touched) && datosForm.nivelEducacion.$error.required}">
                                ...
                                <select class="form-control" id="nivelEducacion" name="nivelEducacion" id="nivelEducacion" ng-model="vacante.nivelEducacion" ng-options="item.id as item.nombre for item in nivelesEducacion" required>
                    ...
                    <div class="text-center">
                        ...
                        <input type="submit" class="btn btn-lg btn-primary" ng-click="guardar(0)" value="Guardar" />
                        <input type="submit" class="btn btn-lg btn-success" ng-click="guardar(1)" value="Guardar y publicar" />
                    </div>
                </fieldset>
