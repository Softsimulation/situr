...
@section('meta_og')
<meta property="og:title" content="{{$noticia->tituloNoticia}}. Publicado por SITUR Atlántico." />
...
<div class="container">
    ...
    <div id="shareButtons" class="text-right">
        ...
        <a href="https://twitter.com/home?status= {{$noticia->tituloNoticia}} por SITUR Atlántico. Lee más en {{\Request::url()}}" role="button" class="btn btn-circle btn-info" title="Compartir en Twitter" target="_blank" rel="noopener noreferrer">
