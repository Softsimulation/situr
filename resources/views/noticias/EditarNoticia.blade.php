    ...
    <div class="container">
        ...
        <div class="tab-content">
                ...
                <form role="form" name="crearForm"  novalidate>
                    <div class="row">
                        <div class="col-md-6 col-xs-12 col-sm-6">
                            ...
                            <select class="form-control" name="idiomaNoticia" id="idiomaNoticia" ng-options="idioma as idioma.nombre for idioma in idiomas" ng-model="editar.idioma" required>
                            </select>
            ...
            <div role="tabpanel" class="tab-pane" id="multimedia" style="padding:30px">
                <br><br>
                <button ng-if="noticia.idIdioma == 1" type="button" class="btn btn-success btn-block" ng-click="abrirModalCrearNoticia()">Agregar multimedia</button>
                <div class="row">
                    <div class="col-xs-12">
