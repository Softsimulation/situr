...
@section('TitleSection', 'Crear noticia')

@section('app','ng-app="admin.noticia"')

@section('controller','ng-controller="crearNoticiaCtrl"')
...
<div class="container">
    ...
    <div class="tab-content">
            ...
            <form role="form" name="crearForm"  novalidate>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <span ng-show="(crearForm.$submitted || crearForm.fuenteNoticia.$touched) && crearForm.fuenteNoticia.$error.url" class="color_errores">* Url.</span>
        ...
        <div role="tabpanel" class="tab-pane" id="multimedia" style="padding:30px">
            <br><br>
            <button type="button" class="btn btn-success btn-block" ng-click="abrirModalCrearNoticia()">Agregar multimedia</button>
            <div class="row">
                <div class="col-xs-12">
                    <table class="table table-hover">
                        ...
                        <tr ng-repeat="x in multimediasNoticias">
                            ...
                            <td>
                              <a href="" ng-click="abrirModalTextoAlternativo(x)" class="btn btn-default" title="Editar texto alternativo" style="float:left"><span class="glyphicon glyphicon-edit"></span></a>
                            </td>
                        </tr>
