        ...
        <div class="row">
            <div class="col-xs-12 col-sm-6 col-md-6">
                <div class="form-group" ng-class="{'has-error': (editarProveedorForm.$submitted || editarProveedorForm.nombre.$touched) && editarProveedorForm.nombre.$error.required}">
                    ...
                    <input ng-model="proveedor.datosGenerales.nombre" required type="text" name="nombre" id="nombre" class="form-control" placeholder="Nombre del proveedor (Máximo 150 caracteres)" maxlength="150"/>
                </div>
            </div>
            <div class="col-xs-12 col-sm-6 col-md-6">
                <div class="form-group">
                    <label for="horario"> Horario</label>
                    <input ng-model="proveedor.datosGenerales.horario" type="text" name="horario" id="horario" class="form-control" placeholder="Horario del proveedor (Máximo 255 caracteres)"/>
                </div>
            </div>
            <div class="col-xs-12">
                <div class="form-group" ng-class="{'has-error': (editarProveedorForm.$submitted || editarProveedorForm.descripcion.$touched) && editarProveedorForm.descripcion.$error.required}">
                    ...
                    <textarea min="100" max="1000" style="resize: none;" ng-model="proveedor.datosGenerales.descripcion" rows="5" required name="descripcion" id="descripcion" class="form-control" placeholder="Descripción del proveedor (De 100 a 1,000 caracteres)" maxlength="1000"></textarea>
