...
@endsection
@section('TitleSection','Caracterización del hogar')
@section('Progreso','0%')
@section('NumSeccion','0%')
@section('Control','ng-controller="editar_Hogar"')
@section('contenido')
<div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12">
                                ...
                                <span ng-show="DatosForm.$submitted || DatosForm.estrato.$touched">
                                    ...
                                    <span class="label label-danger" ng-show="DatosForm.estrato.$error.number">*El campo debe ser un numero válido</span>
                                </span>
                            </div>
                        </div>
                    </div>
                        ...
                        <tr ng-repeat="i in encuesta.integrantes">
                            ...
                            <td class="text-center">
                                <div class="radio radio-primary" style="display: inline-block;margin-top: 0; margin-bottom: 0;">
                                    <label>
                                        <!--P4P4Radio1. Hombre-->
                                        <input type="radio" name="jefe" ng-model="i.jefe_hogar" value="true" ng-change="cambiar($index)">
                                    </label>
                                </div>
                            </td>
