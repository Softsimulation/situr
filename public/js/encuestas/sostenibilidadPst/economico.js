...
.controller('economicoController', ['$scope', 'sostenibilidadPstServi',function ($scope,sostenibilidadPstServi) {
    ...
    $scope.guardar = function(){
        ...
        if( !$scope.datosForm.$valid || $scope.encuesta.clasificacionesProveedor.length == 0 || $scope.encuesta.aspectosSeleccion.length != 2 || ($scope.encuesta.beneficiosEconomicos.length != 3 && $scope.encuesta.beneficiosEconomicos.indexOf(11) == -1) ){
