...
class GrupoViajeController extends Controller
{
    ...
    public function postGuardargrupo(Request $request) {
        ...
        [
       		...
       		'PersonasMag.required' => 'El número de las personas del Atlántico debe ser un valor numérico.',
       		'PersonasMag.numeric' => 'El número de las personas del Atlántico debe ser un valor numérico.',
       		'PersonasMag.between' => 'El número de las personas del Atlántico debe ser un valor numérico mayor o igual a 0.',
