...
class PeriodoSostenibilidadPstController extends Controller
{
    ...
    public function getListado(){
        return view('periodoSostenibilidadPst.index');
    }
    
    public function getListarperiodos(){
        $periodos = Periodo_Sostenibilidad_Pst::withCount('encuestas')->get();
    ...
    public function postGuardarregistro(Request $request){
		...
		$consulta = Periodo_Sostenibilidad_Pst::where(function($q)use($request){
		...
		$registro = Periodo_Sostenibilidad_Pst::create([
	...
	public function postEditarregistro(Request $request){
		...
		$registro = Periodo_Sostenibilidad_Pst::find($request->id);
	...
	public function getDetalle($id){
    	...
    	return view('periodoSostenibilidadPst.detalle',['id' => $id]);
	}
	
	public function getCargardetalle($id){
		$periodo = Periodo_Sostenibilidad_Pst::where('id',$id)->with(['encuestas'=>function($q){$q->with(['proveedoresRnt','estado','digitador'=>function($p){$p->with('user');}]);}])->first();
